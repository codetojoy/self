...
cat 2006_fitness.csv 2007_fitness.csv 2008_fitness.csv \
    ...
    2018_fitness.csv 2019_fitness.csv 2020_fitness.csv \
    2021_fitness.csv 2022_fitness.csv > tmp.csv 

grep -v "Date.*Run.*Bike.*Swim.*Weight.*Notes" tmp.csv > all_fitness.csv
